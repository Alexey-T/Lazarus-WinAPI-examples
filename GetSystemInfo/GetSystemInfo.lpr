...
{$LONGSTRINGS    OFF}
{$WRITEABLECONST ON}
{$DESCRIPTION    'Win32 API function - GetSystemInfo example'}

{$R GetSystemInfo.Res}

program _GetSystemInfo;
  { Win32 API function - GetSystemInfo example                                }
...
const
  { constants used with GetSystemInfo missing in Delphi 2.0                   }
...
const
  GetSystemInfo_Call = 'GetSystemInfo (var SystemInfo : TSYSTEMINFO);';
...
begin
  ...
  case Msg of
    ...
    begin
      ...
      lstrcpy(Buf, GetSystemInfo_Call);
