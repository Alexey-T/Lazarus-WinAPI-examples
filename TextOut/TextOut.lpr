...
{$LONGSTRINGS    OFF}
{$WRITEABLECONST ON}
{$DESCRIPTION    'Win32 API function - TextOut example'}

{$R TextOut.Res}

program _TextOut;
  { Win32 API function - TextOut example                                      }

uses Windows, Messages, Resource;

const
  AppNameBase  = 'TextOut Example';
...
const
  TextOut_Call  = 'TextOut (dc : HDC; x, y : integer; Text : pchar; '
                + 'TextLen : integer) : BOOL;';

  Text          = 'This line is written using TextOut.';
