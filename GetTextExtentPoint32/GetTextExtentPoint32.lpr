...
{$LONGSTRINGS    OFF}
{$WRITEABLECONST ON}
{$DESCRIPTION    'Win32 API function - GetTextExtentPoint32 example'}

{$R GetTextExtentPoint32.Res}

program _GetTextExtentPoint32;
  { Win32 API function - GetTextExtentPoint32 example                         }

uses Windows, Messages, Resource, SysUtils;

const
  AppNameBase  = 'GetTextExtentPoint32 Example';
...
const
  GetTextExtentPoint32_Call
    = 'GetTextExtentPoint32 (dc : HDC; Text : pchar; TextLen : integer; '
    + 'TextSize : TSIZE) : BOOL;';
...
begin
  ...
  case Msg of
    ...
    begin
      ...
      { call GetTextExtentPoint32 to get the string's width and height        }
      ...
      GetTextExtentPoint32(ps.hdc,
                           GetTextExtentPoint32_Call,
                           lstrlen(GetTextExtentPoint32_Call),
                           TextSize);
